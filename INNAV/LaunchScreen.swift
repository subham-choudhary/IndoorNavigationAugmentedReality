...
class LaunchScreen: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        let loadingView = UIView(frame: CGRect(x: 0.0, y: heading.frame.origin.y + heading.frame.height + 6, width: 1.0, height: 3))
        loadingView.backgroundColor = UIColor(red: 1, green: 1, blue: 1, alpha: 0.7)
